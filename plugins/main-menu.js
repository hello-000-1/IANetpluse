...
const defaultVideo = await fetchBuffer('https://files.catbox.moe/xl2nvj.mp4')
...
let handler = async (m, { conn, usedPrefix }) => {
  ...
  await conn.sendMessage(m.chat, {
    ...
    contextInfo: {
      externalAdReply: {
        title: menuMedia.menuTitle || 'NetPLUSE | Versin 1.21.1 🥷🏻',
        body: 'ִ┊࣪ ˖𝐃𝐞𝐯 • 𝐓𝐡𝐞 Elvis ♱',
...
handler.tags = ['main']
handler.command = ['menulist', 'lista', 'help', 'ayuda']
