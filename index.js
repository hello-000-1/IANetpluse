...
█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█
  ...
  console.log(chalk.bold.white('      SISTEMA CREO POR: ') + chalk.bold.hex('#FFD700')('Elvis 👑'))
  console.log(chalk.bold.hex('#FF00FF')('⌬═══════════════════════⌬\n'))
...
function start(file) {
  if (isRunning) return
  isRunning = true
  let args = [join(__dirname, 'nucleo-netpluse', file), ...process.argv.slice(2)]
